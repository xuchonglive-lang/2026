  ...
  <view class="page-body">
    ...
    <el-row>
      <el-col :span="24" style="padding: 40rpx">
        <div style="padding: 40rpx 0rpx; font-size: 40rpx; font-family: simsun">基础用法:</div>
    ...
    <el-row>
      <el-col :span="24" style="padding: 40rpx">
        <div style="padding: 40rpx 0rpx; font-size: 40rpx; font-family: simsun">不同状态:</div>
    ...
    <el-row>
      <el-col :span="24" style="padding: 40rpx">
        <div style="padding: 40rpx 0rpx; font-size: 40rpx; font-family: simsun">可关闭:</div>
    ...
    <el-row>
      <el-col :span="24" style="padding: 40rpx">
        <div style="padding: 40rpx 0rpx; font-size: 40rpx; font-family: simsun">文字居中:</div>
    ...
    <el-row>
      <el-col :span="24" style="padding: 40rpx">
        <div style="padding: 40rpx 0rpx; font-size: 40rpx; font-family: simsun">嵌入HMTL片段:</div>
