<template>
  <view class="page-body">
    <!-- 页面内容开始 -->
    <div style="padding: 40rpx; font-size: 70rpx; font-family: kaiti">提示弹框功能演示</div>
    ...
    <el-row>
      <el-col :span="24" style="padding: 40rpx">
        ...
        <el-popover ref="popover" placement="right" title="标题" width="200" style="" trigger="focus" content="这是一段内容,这是一段内容,这是一段内容,这是一段内容。"> </el-popover>
    ...
    <el-row>
      <el-col :span="24" style="padding: 40rpx">
        <div style="padding: 40rpx 0rpx; font-size: 40rpx; font-family: simsun">嵌套信息:</div>
    ...
    <el-row>
      <el-col :span="24" style="padding: 40rpx">
        <div style="padding: 40rpx 0rpx; font-size: 40rpx; font-family: simsun">嵌套操作:</div>
