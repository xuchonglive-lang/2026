<template>
  <view class="page">
    <!-- 页面内容开始 -->
    <vk-data-page-header title="Form 表单详情" subTitle="展示表单详情"></vk-data-page-header>

    <view class="page-body" style="max-width: 800px; margin: 0 auto">
      <vk-data-detail-table :data="data" :columns="columns" size="medium" label-width="150px"></vk-data-detail-table>
    </view>
    <!-- 页面内容结束 -->
  </view>
</template>
    ...
    data() {
      ...
      return {
        ...
        columns: [
          ...
          { key: 'textarea', title: 'textarea类型字段', type: 'textarea', autosize: { minRows: 6, maxRows: 10 } },
