    ...
    data() {
      ...
      return {
        ...
        queryForm1: {
          ...
          columns: [
            { key: 'money_1', type: 'money', title: '金额范围', width: 160, placeholder: '请输入最小金额', mode: '>=', fieldName: 'money' },
            { key: 'money_2', type: 'money', title: '-', width: 160, placeholder: '请输入最大金额', mode: '<=', fieldName: 'money' },
