<template>
  <view class="page">
    <!-- 页面内容开始 -->
    <vk-data-page-header title="Form 表单" subTitle="行内表单"></vk-data-page-header>
        ...
        form1: {
          ...
          props: {
            ...
            columns: [
              ...
              { key: 'user_id', title: '用户选择器', type: 'remote-select', placeholder: '请输入用户账号', action: 'admin/system/user/kh/select' },
              ...
              { key: 'textarea', title: 'textarea类型字段', type: 'textarea', autosize: { minRows: 6, maxRows: 10 }, maxlength: 200, showWordLimit: true, width: 820 },
            ],
            // 表单验证规则
            rules: {},
