<template>
  <view class="page">
    <!-- 页面内容开始 -->
    <vk-data-page-header title="Form 表单" subTitle="基础表单"></vk-data-page-header>
        ...
        form1: {
          ...
          props: {
            ...
            columns: [
              ...
              { key: 'textarea', title: 'textarea类型字段', type: 'textarea', autosize: { minRows: 4, maxRows: 10 }, showWordLimit: true },
