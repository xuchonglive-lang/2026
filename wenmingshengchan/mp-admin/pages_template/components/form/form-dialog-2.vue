<template>
  <view class="page">
    <!-- 页面内容开始 -->
    <vk-data-page-header title="Form 表单" subTitle="复用同一个表单实现添加和修改"></vk-data-page-header>
        ...
        form1: {
          ...
          props: {
            ...
            columns: [
              ...
              { key: 'textarea', title: 'textarea类型字段', type: 'textarea', autosize: { minRows: 4, maxRows: 10 }, maxlength: 200, showWordLimit: true },
    ...
    methods: {
      ...
      showForm(type) {
        ...
        if (type === 'add') {
          ...
          form1.props.action = 'template/pub.db.test';
        } else {
