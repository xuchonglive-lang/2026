<template>
  <view class="page">
    <!-- 页面内容开始 -->
    <vk-data-page-header title="Form 表单" subTitle="高级表单"></vk-data-page-header>
        ...
        form1: {
          ...
          props: {
            ...
            columns: [
              ...
              { key: 'user_id', title: '用户选择器', type: 'remote-select', placeholder: '请输入用户账号/昵称', action: 'admin/system/user/kh/select' },
              {
                key: 'user_id',
                title: '选择用户',
                type: 'table-select',
