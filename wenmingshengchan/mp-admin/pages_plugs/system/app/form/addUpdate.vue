      ...
      return {
        ...
        form1: {
          ...
          props: {
            ...
            columns: [
                    ...
                    children: [
                      {
                        value: '1001',
                        label: '通用',
                        children: [{ value: 'client', label: '用户端' }],
                      },
                      {
                        value: '1002',
                        label: '商家',
                    ...
                    children: [
                      {
                        value: '2001',
                        label: '通用',
                        children: [{ value: 'admin', label: '管理端' }],
                      },
                      {
                        value: '2002',
                        label: '商家',
                      ...
                      },
                      {
                        value: '2999',
                        label: '其他',
                        children: [{ value: 'other-admin', label: '其他管理端' }],
                      },
                    ],
                  },
                ],
              ...
              },
              {
                ...
                watch: ({ value, formData, column, index, $set }) => {
                  ...
                  let arr = ['app_ios', 'app_android', 'mp_weixin', 'mp_alipay', 'mp_baidu', 'mp_toutiao', 'mp_qq', 'mp_kuaishou', 'mp_lark', 'mp_jd', 'mp_dingtalk', 'quickapp'];
                  arr.map((item, index) => {
              ...
              { key: '', title: 'H5信息', type: 'bar-title', showRule: 'enable_upgrade_center==true' },
              {
                ...
                type: 'object',
                showLabel: false,
                columns: [{ key: 'url', title: '链接地址', type: 'text', tips: '您的h5首页访问地址' }],
            ...
            // 表单验证规则
            rules: {
              appid: [{ required: true, message: '应用的AppID为必填字段', trigger: 'blur' }],
              name: [{ required: true, message: '应用名称为必填字段', trigger: 'blur' }],
              type: [{ required: true, message: '应用类型为必填字段', trigger: 'blur' }],
            },
            // 左侧label的宽度
            labelWidth: '140px',
          },
