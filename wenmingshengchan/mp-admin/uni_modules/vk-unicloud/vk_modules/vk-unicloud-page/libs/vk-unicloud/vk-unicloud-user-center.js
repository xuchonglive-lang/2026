...
const localeObj = {
  ...
  uk: {
    loading: 'loading...', // Завантаження... 单词太长，故用loading...
    login: 'Вхід...',
    register: 'Реєстрація...',
    create: 'Створення...',
  },
...
export default {
  ...
  loginByUniverify(obj = {}) {
    ...
    return new Promise((resolve, reject) => {
      ...
      univerifyManager.login({
        // #ifdef APP-HARMONY
        univerifyStyle: {
          fullScreen: obj.univerifyStyle.fullScreen,
          logoPath: obj.univerifyStyle.icon && obj.univerifyStyle.icon.path,
          loginBtnText: obj.univerifyStyle.authButton && obj.univerifyStyle.authButton.title,
        },
        // #endif
        // #ifndef APP-HARMONY
  ...
  getWeixinMPqrcode(obj = {}) {
    ...
    if (obj.data && obj.data.env_version === 'auto') {
      obj.data.env_version = uni.vk.pubfn.getMiniProgramEnvVersion();
    }
    return callFunction({
      ...obj,
