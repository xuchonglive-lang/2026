<template>
	<view>
		...
		<cu-custom bgColor="bg-gradual-orange" :isCustom="true">
			...
			<block slot="content">管理下井材料信息</block>
		</cu-custom>
	<!-- #endif -->
	<view class="searchbox">
		...
		<mescroll-body ref="mescrollRef" @init="mescrollInit" @down="downCallback" @up="upCallback" :down="downOption"
			...
			<mark-slide-list :list="descentofmaterialList" :button="buttonList" :border="true" @click="clickMethod"
...
<script>
	...
	import markSlideList from '@/components/mark-slide-list/mark-slide-list3.vue'
	export default {
		...
		methods: {
			...
			async changeMethod(data, button, index) {
				...
				uni.navigateTo({
									url: `../addDescentofmaterialDialog/addDescentofmaterialDialog?id=${id}`
								})
