...
/**
 * @desc 格式化日期字符串
 * @param { dateString1（前几天），dateString2（今天） 为字符串} - 
 * @returns { int } 返回相差几天
     // 2012年01月10日 12:46
     //刚刚
    //16分钟前
...
// 返回前number天的日期格式为2020-02-02，参数number为前几天,返回前 number天的日期
...
/* 判断两个对象的属性是否相等 */
export const testObjSame = (obj1, obj2) => {
     // debugger
      if (obj1 === obj2) {// 常规情况
        return true
      }
...
// 检查输入的内容为3个汉字以内
export const checkTextofNum=(chars)=>{
	var sum = 0;
