				...
				form1: {
					...
					props: {
						...
						columns: [
							...
							{
								key: "radio1", title: "radio类型1", type: "radio", itemWidth: 80,
								data: [
									{ value: 1, label: "选项1" },
									{ value: 2, label: "选项2" }
								]
							...
							{
								key: "checkbox1", title: "checkbox类型1", type: "checkbox", itemWidth: 80,
								data: [
									{ value: 1, label: "选项1" },
									{ value: 2, label: "选项2" }
								]
							...
							{
								key: "radio2", title: "radio类型2", type: "radio", border: true, itemWidth: 80,
								data: [
									{ value: 1, label: "选项1" },
									{ value: 2, label: "选项2" }
								]
							...
							{
								key: "checkbox2", title: "checkbox类型2", type: "checkbox", border: true, itemWidth: 80,
								data: [
									{ value: 1, label: "选项1" },
									{ value: 2, label: "选项2" }
								]
							...
							{
								key: "radio3", title: "radio类型3", type: "radio", optionType: 'button',
								data: [
									{ value: 1, label: "选项1" },
									{ value: 2, label: "选项2" }
								]
							...
							{
								key: "checkbox3", title: "checkbox类型3", type: "checkbox", optionType: 'button',
								data: [
									{ value: 1, label: "选项1" },
									{ value: 2, label: "选项2" }
								]
							...
							{
								key: "select2", title: "select类型2", type: "select", multiple: true, multipleLimit: 2,
								data: [
									{ value: 1, label: "选项1" },
									{ value: 2, label: "选项2" },
									{ value: 3, label: "选项3" },
							...
							},
							{
								...
								props: { list: "rows", value: "menu_id", label: "label", children: "children", lazy: true }
							},
							{
							...
							{
								key: "tree2", title: "树形选择(多选)", type: "tree-select", placeholder: "请选择学科", multiple: true,
								data: [{
										value: 1,
										label: "数学",
										children: [
							...
							{ key: "image1", title: "image类型", type: "image", limit: 6 },
							 {key: "image2", title: "拖拽上传", type: "image", limit: 6, drag: true, fileSize: 2, sizeUnit: "mb", tips: "图片大小限制：小于2M" },
							{
								key: "file", title: "文件类型", type: "file", limit: 6,
							...
							{
								key: "time2", title: "time类型2", type: "time", valueFormat: "HH:mm",
								pickerOptions: {
									format: "HH:mm"
								}
							},
							...
							{
								key: "timeArr2", title: "time类型范围2", type: "time", isRange: true, valueFormat: "HH:mm",
								pickerOptions: {
							...
							{
								key: "array", title: "数组对象类型", type: "array<object>",
								itemWidth: 260,
								showAdd: true,
								showClear: true,
								showSort: true,
